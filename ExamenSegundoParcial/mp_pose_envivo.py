  ...
  while True:
    ...
    if results.pose_landmarks is not None:
      # Usa las dimensiones redimensionadas para calcular x1 y y1
            ...
            cv2.line(frame, (x3, y3), (x4, y4), (255, 255, 255), 3)
            cv2.line(frame, (x4, y4), (x5, y5), (255, 255, 255), 3)
            cv2.line(frame, (x5, y5), (x6, y6), (255, 255, 255), 3)
            cv2.line(frame, (x6, y6), (x7, y7), (255, 255, 255), 3)

            cv2.circle(frame, (x1, y1), 6, (128, 0, 255), -1)
            cv2.circle(frame, (x2, y2), 6, (128, 0, 255), -1)
            cv2.circle(frame, (x3, y3), 6, (128, 0, 255), -1)
            cv2.circle(frame, (x4, y4), 6, (128, 0, 255), -1)
            cv2.circle(frame, (x5, y5), 6, (128, 0, 255), -1) 
            cv2.circle(frame, (x6, y6), 6, (128, 0, 255), -1)
            cv2.circle(frame, (x7, y7), 6, (128, 0, 255), -1)
